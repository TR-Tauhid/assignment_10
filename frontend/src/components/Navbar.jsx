...
const Navbar = () => {
  ...
  return (
    <div className="navbar  shadow-sm justify-between lg:justify-around mt-6">
      <Helmet>
        <meta charSet="utf-8" />
      ...
      <div className="flex justify-around items-center gap-x-3">
        ...
        <div title="Sorry I couldn't implement theme functionality of daisyUI. For Tailwind Version complication. ">
          ...
          <>
            <div className="flex-none">
              <div className="dropdown dropdown-hover dropdown-end">
                ...
                <ul
                  tabIndex={0}
                  className="menu menu-sm dropdown-content  rounded-box z-1 mt-3 w-24 lg:w-52 p-2"
                >
                  <li
